...
extern TSDLLEXPORT void ts_debug_point_wait_internal(const char *name, bool blocking);
extern TSDLLEXPORT void ts_debug_point_raise_error_if_enabled(const char *name);

#ifdef TS_DEBUG

#define DEBUG_WAITPOINT(NAME) ts_debug_point_wait_internal((NAME), true)
#define DEBUG_RETRY_WAITPOINT(NAME) ts_debug_point_wait_internal((NAME), false)
